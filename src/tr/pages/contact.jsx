  ...
  return (
    ...
    <section className="">
      <div className=" w-11/12 px-6 py-12 mx-auto">
        <div>
          <p className="font-medium text-primary">İletişim</p>

          <h1 className="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl ">Bizimle İletişime Geçin</h1>

          <p className="mt-3 text-gray-500 ">Dost canlısı ekibimiz sizden haber almaktan mutluluk duyacaktır.</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
          <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
            <div>
              ...
              <p className="mt-2 text-sm text-gray-500 ">Dost canlısı ekibimiz yardıma hazır.</p>
              {/* <Link
                to={"info@maf.gen.tr"}
              >
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-gray-500 ">Gelin, ofisimizin genel merkezine merhaba deyin.</p>
            ...
            <div>
              ...
              <h2 className="mt-4 text-base font-medium text-gray-800 ">Telefon</h2>
              <p className="mt-2 text-sm text-gray-500">Pazartesi-Cuma sabah 8'den akşam 5'e kadar.</p>
              <p
                className="mt-2 text-sm text-primary"
                onClick={(e) => {
